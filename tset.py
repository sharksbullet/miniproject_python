...
dropdown = ttk.Combobox(root, textvariable=dropdown_var,width=100)
dropdown2 = ttk.Combobox(root, textvariable=dropdown_var2,width=100)
...
label2.pack()
dropdown2.pack()
action_button = tk.Button(root, text="submit", command=perform_action,font=("Arial",15),bg='green', fg='white')
action_button.pack()
